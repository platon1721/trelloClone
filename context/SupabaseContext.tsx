...
type ProviderProps = {
    ...
    addListCard: (listId: string, boardId: string, title: string, position?: number, image_url?: string | null) => Promise<any>;
    ...
    getRealtimeCardSubscription: (id: string, handleRealtimeChanges: (update: RealtimePostgresChangesPayload<any>) => void) => any;
...
export const SupabaseProvider = ({children}: {children: ReactNode}) => {
    ...
    // User and Collaboration Functions
